...
train_loader = torch.utils.data.DataLoader(
    datasets.MNIST('/home/xd/disk/data/mnist', train=True, download=True,
...
test_loader = torch.utils.data.DataLoader(
    datasets.MNIST('/home/xd/disk/data/mnist', train=False, transform=transforms.Compose([
                       transforms.ToTensor(),
                       transforms.Normalize((0.1307,), (0.3081,))
                   ])),
    batch_size=args.batch_size, shuffle=True, **kwargs)
...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if batch_idx % args.log_interval == 0:
            ...
            sys.stdout.write('Train Epoch: %3d [%3d/%3d (%3d %%)]\tLoss: %0.6f\tLoss error: %0.6f\tLoss weights: %0.6f'%
